...
public class Player {
    ...
    {
        System.out.println("\nSilah : "+this.getInventory().getWeapon().getName()+"\t Zırh : "+this.getInventory().getArmor().getName()+"\t Engelleme : "
    +this.getInventory().getArmor().getBlock()+"\t Hasar : "+this.gettotalDamage()+"\t Sağlık : "+this.getHealth()+" Para : "+this.money);
    }
