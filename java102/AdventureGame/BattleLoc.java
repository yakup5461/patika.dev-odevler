...
public class BattleLoc extends Location{
    ...
    public Boolean onLocation() {
            ...
            System.out.println( "Dikkatli Ol! Burası " + this.obstacle.getName() + " Mekanı " + this.obstacle.getName() + " Sayısı : " + obsNumber );
            System.out.println("\n              Kaybetmeden Kazanmayı Ögrenemezsin              \n");
            System.out.println("\n              Düşmanlarının Korkulu Rüyası Ol !              \n");
            System.out.print("\nSavaş Yada Kaç : ");
            String selectBattleCase = Location.input.next().toUpperCase();
            if ((selectBattleCase.equals("S")|| selectBattleCase.equals("s"))&& combat(obsNumber)) {
    ...
    public boolean combat(int obsNumber)
    {
        ...
        for (int i=obsNumber;i>=1;i--) {
            ...
            if (this.getObstacle().getHealth()<this.getPlayer().getHealth())
            {
                ...
                System.out.println("\nYeni Paranız : "+this.getPlayer().getMoney()+"\n");
            }
            else return false;
        }
        return true;
    ...
    public void obstacleAttack() {
        if (this.getObstacle().getHealth()>0) {
            System.out.println();
            System.out.println("Hey Düşmanların Canına Kastediyor !\n");
